...
public class UsuariosController implements Serializable {
    ...
    private LazyDataModel<Usuarios> lazyModel = null;
    @EJB
    ...
    public void setSelected(Usuarios entity) {
        current = entity;
    }
        ...
        if (lazyModel == null) {
            lazyModel = new LazyDataModel<Usuarios>() {
                ...
                public List<Usuarios> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
                    ...
                    List<Usuarios> result = getFacade().getResultList(first, pageSize, sortField, sortOrder, filters);
                    if (result.isEmpty()) {
                ...
                @Override
                public Usuarios getRowData(String rowKey) {
                    try {
    ...
    public String prepareView() {
        current = (Usuarios) getLazyModel().getRowData();
        return "View";
    }
